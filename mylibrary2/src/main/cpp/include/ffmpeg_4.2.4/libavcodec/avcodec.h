...
#define FF_MB_DECISION_RD     2        ///< rate distortion
     ...
     * this callbackToJava may be called from a different thread, but not from more
 ...
 *   the new free callbackToJava must call the potentially set previous free callback.
